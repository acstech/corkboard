...
import (
  "fmt"
	...
	"net/http"
  "os"
	corkboard "github.com/acstech/corkboard"
...
func main() {
	cork, err := corkboard.NewCorkboard(&corkboard.Config{
		Connection:   os.Getenv("CONNECTION"),
		BucketName:       os.Getenv("BUCKET_NAME"),
		BucketPass:   os.Getenv("BUCKET_PASS"),
	})
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	...
	log.println(Println("Listening on port 8091"))
	log.Fatal(http.ListenAndServe(":8091", cork.Router()))
}
